...
import { ModelReference, MessageData, CandidateData, ModelInfo, ModelAction } from 'genkit/model';
...
declare const SUPPORTED_GEMINI_MODELS: Record<string, ModelReference<typeof GeminiConfigSchema>>;
 ...
 */
declare function defineGoogleAIModel(ai: Genkit, name: string, apiKey?: string, apiVersion?: string, baseUrl?: string, info?: ModelInfo, defaultConfig?: z.infer<typeof GeminiConfigSchema>): ModelAction;

export { GeminiConfigSchema, SUPPORTED_GEMINI_MODELS, SUPPORTED_V15_MODELS, SUPPORTED_V1_MODELS, cleanSchema, defineGoogleAIModel, fromGeminiCandidate, gemini10Pro, gemini15Flash, gemini15Flash8b, gemini15Pro, toGeminiMessage, toGeminiSystemInstruction };
