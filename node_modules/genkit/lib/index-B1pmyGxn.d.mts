...
import { z, FlowConfig, FlowFn, CallableFlow, StreamingFlowConfig, StreamableFlow, JSONSchema, StreamingCallback, FlowServerOptions, FlowServer } from '@genkit-ai/core';
...
declare class Genkit {
     ...
     */
    defineFlow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny>(config: FlowConfig<I, O> | string, fn: FlowFn<I, O>): CallableFlow<I, O>;
    /**
