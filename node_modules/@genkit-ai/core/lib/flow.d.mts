...
import { z } from 'zod';
import { k as StreamingCallback, R as Registry } from './action-CVNsYZ0U.mjs';
import 'json-schema';
 ...
 */
interface CallableFlow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny> {
    (input?: z.infer<I>, opts?: {
 ...
 */
declare function defineFlow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny>(registry: Registry, config: FlowConfig<I, O> | string, fn: FlowFn<I, O, z.ZodVoid>): CallableFlow<I, O>;
/**
...
export { type CallableFlow, Flow, type FlowAuthPolicy, type FlowConfig, type FlowFn, FlowServer, type FlowServerOptions, type StreamableFlow, type StreamingFlowConfig, type __RequestWithAuth, defineFlow, defineStreamingFlow, run };
