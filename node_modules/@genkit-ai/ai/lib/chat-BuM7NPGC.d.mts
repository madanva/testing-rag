...
import { d as GenerateOptions, E as ExecutablePrompt, e as GenerateStreamOptions, f as GenerateStreamResponse } from './generate-BNGmNjjG.mjs';
import { MessageData, GenerationCommonConfigSchema, Part } from './model.mjs';
...
declare class Session<S = any> {
     ...
     */
    updateMessages(thread: string, messasges: MessageData[]): Promise<void>;
    /**
